...
Samantha_Investment = Investment.create(balance: 100, start_date: Date.parse('2016-09-05'), interest_rate: 2, child_id: 2 )
...
Sam_Jr_Investment = Investment.create(balance: 100, start_date: Date.parse('2015-09-05'), interest_rate: 2, child_id: 1 )
